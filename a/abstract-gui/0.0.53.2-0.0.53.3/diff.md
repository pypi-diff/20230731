# Comparing `tmp/abstract_gui-0.0.53.2.tar.gz` & `tmp/abstract_gui-0.0.53.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "abstract_gui-0.0.53.2.tar", last modified: Mon Jul 31 05:22:02 2023, max compression
+gzip compressed data, was "abstract_gui-0.0.53.3.tar", last modified: Mon Jul 31 05:30:18 2023, max compression
```

## Comparing `abstract_gui-0.0.53.2.tar` & `abstract_gui-0.0.53.3.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-31 05:22:02.192176 abstract_gui-0.0.53.2/
--rw-r--r--   0 root         (0) root         (0)     9210 2023-07-31 05:22:02.192176 abstract_gui-0.0.53.2/PKG-INFO
--rw-rw-r--   0 root         (0) root         (0)     8473 2023-07-31 00:08:47.000000 abstract_gui-0.0.53.2/README.md
--rw-rw-r--   0 root         (0) root         (0)       85 2023-07-29 19:09:21.000000 abstract_gui-0.0.53.2/pyproject.toml
--rw-rw-r--   0 root         (0) root         (0)       38 2023-07-31 05:22:02.192176 abstract_gui-0.0.53.2/setup.cfg
--rw-rw-r--   0 root         (0) root         (0)     1124 2023-07-31 05:21:48.000000 abstract_gui-0.0.53.2/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-31 05:22:02.192176 abstract_gui-0.0.53.2/src/
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-07-31 05:22:02.192176 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/
--rw-r--r--   0 root         (0) root         (0)     9210 2023-07-31 05:22:02.000000 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      242 2023-07-31 05:22:02.000000 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-07-31 05:22:02.000000 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       31 2023-07-31 05:22:02.000000 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-07-31 05:22:02.000000 abstract_gui-0.0.53.2/src/abstract_gui.egg-info/top_level.txt
...
### Comparing `abstract_gui-0.0.53.2/PKG-INFO` & `abstract_gui-0.0.53.3/PKG-INFO`
...
### Comparing `abstract_gui-0.0.53.2/README.md` & `abstract_gui-0.0.53.3/README.md`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.53.2/setup.py` & `abstract_gui-0.0.53.3/setup.py`
...
### Comparing `abstract_gui-0.0.53.2/src/abstract_gui.egg-info/PKG-INFO` & `abstract_gui-0.0.53.3/src/abstract_gui.egg-info/PKG-INFO`

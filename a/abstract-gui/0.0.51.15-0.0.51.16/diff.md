# Comparing `tmp/abstract_gui-0.0.51.15.tar.gz` & `tmp/abstract_gui-0.0.51.16.tar.gz`
...
## Comparing `abstract_gui-0.0.51.15.tar` & `abstract_gui-0.0.51.16.tar`
...
### Comparing `abstract_gui-0.0.51.15/PKG-INFO` & `abstract_gui-0.0.51.16/PKG-INFO`
...
### Comparing `abstract_gui-0.0.51.15/README.md` & `abstract_gui-0.0.51.16/README.md`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.51.15/setup.py` & `abstract_gui-0.0.51.16/setup.py`
...
### Comparing `abstract_gui-0.0.51.15/src/abstract_gui.egg-info/PKG-INFO` & `abstract_gui-0.0.51.16/src/abstract_gui.egg-info/PKG-INFO`

# Comparing `tmp/abstract_gui-0.0.51.13.tar.gz` & `tmp/abstract_gui-0.0.51.14.tar.gz`
...
## Comparing `abstract_gui-0.0.51.13.tar` & `abstract_gui-0.0.51.14.tar`
...
### Comparing `abstract_gui-0.0.51.13/PKG-INFO` & `abstract_gui-0.0.51.14/PKG-INFO`
...
### Comparing `abstract_gui-0.0.51.13/README.md` & `abstract_gui-0.0.51.14/README.md`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.51.13/setup.py` & `abstract_gui-0.0.51.14/setup.py`
...
### Comparing `abstract_gui-0.0.51.13/src/abstract_gui/main.py` & `abstract_gui-0.0.51.14/src/abstract_gui/main.py`

 * *Files identical despite different names*

### Comparing `abstract_gui-0.0.51.13/src/abstract_gui.egg-info/PKG-INFO` & `abstract_gui-0.0.51.14/src/abstract_gui.egg-info/PKG-INFO`

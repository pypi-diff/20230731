# Comparing `tmp/qoa4ml-0.0.86.tar.gz` & `tmp/qoa4ml-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "qoa4ml-0.0.86.tar", last modified: Mon Jul 31 13:14:44 2023, max compression
...
## Comparing `qoa4ml-0.0.86.tar` & `qoa4ml-0.0.9.tar`

### file list

```diff
@@ -1,35 +1,34 @@
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.009571 qoa4ml-0.0.86/
--rw-r--r--   0 tringuyen   (501) wheel        (0)      563 2023-05-22 14:23:36.000000 qoa4ml-0.0.86/CHANGELOG.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1047 2022-03-23 13:04:50.000000 qoa4ml-0.0.86/LICENCE.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)       39 2023-07-31 12:17:09.000000 qoa4ml-0.0.86/MANIFEST.in
--rw-r--r--   0 tringuyen   (501) wheel        (0)     7674 2023-07-31 13:14:44.009319 qoa4ml-0.0.86/PKG-INFO
--rw-r--r--   0 tringuyen   (501) wheel        (0)     6840 2023-07-31 10:28:13.000000 qoa4ml-0.0.86/README.md
--rw-r--r--   0 tringuyen   (501) wheel        (0)        7 2023-07-31 13:14:23.000000 qoa4ml-0.0.86/VERSION
--rw-r--r--   0 tringuyen   (501) wheel        (0)       84 2022-09-02 11:22:46.000000 qoa4ml-0.0.86/pyproject.toml
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.003718 qoa4ml-0.0.86/qoa4ml/
--rw-r--r--   0 tringuyen   (501) wheel        (0)    13178 2023-07-31 12:32:13.000000 qoa4ml-0.0.86/qoa4ml/QoaClient.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:03.000000 qoa4ml-0.0.86/qoa4ml/__init__.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.006207 qoa4ml-0.0.86/qoa4ml/collector/
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2022-03-23 14:05:26.000000 qoa4ml-0.0.86/qoa4ml/collector/__init__.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2120 2023-01-30 17:43:18.000000 qoa4ml-0.0.86/qoa4ml/collector/amqp_collector.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.007763 qoa4ml-0.0.86/qoa4ml/connector/
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2022-03-23 14:05:29.000000 qoa4ml-0.0.86/qoa4ml/connector/__init__.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2093 2023-01-30 16:55:55.000000 qoa4ml-0.0.86/qoa4ml/connector/amqp_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1379 2022-03-23 09:27:48.000000 qoa4ml-0.0.86/qoa4ml/connector/mess_logging.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1611 2022-03-23 09:32:08.000000 qoa4ml-0.0.86/qoa4ml/connector/mqtt_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2189 2022-03-23 09:33:14.000000 qoa4ml-0.0.86/qoa4ml/connector/prom_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     4209 2023-07-31 09:58:49.000000 qoa4ml-0.0.86/qoa4ml/metric.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.008891 qoa4ml-0.0.86/qoa4ml/probes/
--rw-r--r--   0 tringuyen   (501) wheel        (0)     6691 2023-07-18 06:51:33.000000 qoa4ml-0.0.86/qoa4ml/probes/dataquality.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     4587 2023-05-31 13:54:44.000000 qoa4ml-0.0.86/qoa4ml/probes/mlquality.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     6938 2023-07-31 12:22:01.000000 qoa4ml-0.0.86/qoa4ml/reports.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)    11188 2023-07-31 10:44:37.000000 qoa4ml-0.0.86/qoa4ml/utils.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-07-31 13:14:44.005613 qoa4ml-0.0.86/qoa4ml.egg-info/
--rw-r--r--   0 tringuyen   (501) wheel        (0)     7674 2023-07-31 13:14:43.000000 qoa4ml-0.0.86/qoa4ml.egg-info/PKG-INFO
--rw-r--r--   0 tringuyen   (501) wheel        (0)      622 2023-07-31 13:14:43.000000 qoa4ml-0.0.86/qoa4ml.egg-info/SOURCES.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)        1 2023-07-31 13:14:43.000000 qoa4ml-0.0.86/qoa4ml.egg-info/dependency_links.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)      235 2023-07-31 13:14:43.000000 qoa4ml-0.0.86/qoa4ml.egg-info/requires.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)        7 2023-07-31 13:14:43.000000 qoa4ml-0.0.86/qoa4ml.egg-info/top_level.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)      235 2023-07-31 13:04:18.000000 qoa4ml-0.0.86/requirements.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)       38 2023-07-31 13:14:44.009660 qoa4ml-0.0.86/setup.cfg
--rw-r--r--   0 tringuyen   (501) wheel        (0)      711 2023-07-31 12:17:09.000000 qoa4ml-0.0.86/setup.py
...
### Comparing `qoa4ml-0.0.86/LICENCE.txt` & `qoa4ml-0.0.9/LICENCE.txt`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.86/qoa4ml/collector/amqp_collector.py` & `qoa4ml-0.0.9/qoa4ml/collector/qmqp_collector.py`
...
### Comparing `qoa4ml-0.0.86/qoa4ml/connector/amqp_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/amqp_client.py`
...
### Comparing `qoa4ml-0.0.86/qoa4ml/connector/mess_logging.py` & `qoa4ml-0.0.9/qoa4ml/connector/mess_logging.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.86/qoa4ml/connector/mqtt_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/mqtt_client.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.86/qoa4ml/connector/prom_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/prom_connector.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.86/qoa4ml.egg-info/SOURCES.txt` & `qoa4ml-0.0.9/qoa4ml/qoa4ml.egg-info/SOURCES.txt`

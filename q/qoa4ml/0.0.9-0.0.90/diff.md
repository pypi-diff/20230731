# Comparing `tmp/qoa4ml-0.0.9.tar.gz` & `tmp/qoa4ml-0.0.90.tar.gz`
...
## Comparing `qoa4ml-0.0.9.tar` & `qoa4ml-0.0.90.tar`
...
### Comparing `qoa4ml-0.0.9/LICENCE.txt` & `qoa4ml-0.0.90/LICENCE.txt`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.9/qoa4ml/collector/qmqp_collector.py` & `qoa4ml-0.0.90/qoa4ml/collector/amqp_collector.py`
...
### Comparing `qoa4ml-0.0.9/qoa4ml/connector/amqp_client.py` & `qoa4ml-0.0.90/qoa4ml/connector/amqp_connector.py`
...
### Comparing `qoa4ml-0.0.9/qoa4ml/connector/mess_logging.py` & `qoa4ml-0.0.90/qoa4ml/connector/mess_logging.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.9/qoa4ml/connector/mqtt_client.py` & `qoa4ml-0.0.90/qoa4ml/connector/mqtt_connector.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.9/qoa4ml/connector/prom_connector.py` & `qoa4ml-0.0.90/qoa4ml/connector/prom_connector.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.9/qoa4ml/qoa4ml.egg-info/SOURCES.txt` & `qoa4ml-0.0.90/qoa4ml.egg-info/SOURCES.txt`

# Comparing `tmp/quickbar-0.0.3.tar.gz` & `tmp/quickbar-0.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "quickbar-0.0.3.tar", max compression
+gzip compressed data, was "quickbar-0.1.0.tar", max compression
```

## Comparing `quickbar-0.0.3.tar` & `quickbar-0.1.0.tar`

### file list

```diff
@@ -1,7 +1,42 @@
--rw-r--r--   0        0        0      434 2023-07-28 00:37:36.475223 quickbar-0.0.3/README.md
--rw-r--r--   0        0        0      564 2023-07-31 02:04:05.673016 quickbar-0.0.3/pyproject.toml
--rw-r--r--   0        0        0      234 2023-07-28 00:27:29.256852 quickbar-0.0.3/quickbar/README.md
--rw-r--r--   0        0        0       41 2023-07-27 18:42:44.521026 quickbar-0.0.3/quickbar/__init__.py
--rw-r--r--   0        0        0     1962 2023-07-28 00:25:31.648766 quickbar-0.0.3/quickbar/__main__.py
--rw-r--r--   0        0        0     2596 2023-07-31 02:02:48.808892 quickbar-0.0.3/quickbar/core.py
--rw-r--r--   0        0        0     1120 1970-01-01 00:00:00.000000 quickbar-0.0.3/PKG-INFO
...
### Comparing `quickbar-0.0.3/quickbar/__main__.py` & `quickbar-0.1.0/quickbar/__main__.py`

 * *Files identical despite different names*

### Comparing `quickbar-0.0.3/quickbar/core.py` & `quickbar-0.1.0/quickbar/core.py`

# Comparing `tmp/knifes-0.8.89.tar.gz` & `tmp/knifes-0.8.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "knifes-0.8.89.tar", last modified: Mon Jul 31 14:58:12 2023, max compression
+gzip compressed data, was "knifes-0.8.9.tar", last modified: Thu Nov  3 11:19:21 2022, max compression
```

## Comparing `knifes-0.8.89.tar` & `knifes-0.8.9.tar`

### file list

```diff
@@ -1,39 +1,36 @@
-drwxr-xr-x   0 hwei       (501) staff       (20)        0 2023-07-31 14:58:12.965871 knifes-0.8.89/
--rw-r--r--   0 hwei       (501) staff       (20)      766 2023-07-31 14:58:12.965736 knifes-0.8.89/PKG-INFO
--rw-r--r--   0 hwei       (501) staff       (20)      400 2022-09-02 05:25:28.000000 knifes-0.8.89/README.md
-drwxr-xr-x   0 hwei       (501) staff       (20)        0 2023-07-31 14:58:12.964726 knifes-0.8.89/knifes/
--rw-r--r--   0 hwei       (501) staff       (20)        0 2022-01-21 03:14:54.000000 knifes-0.8.89/knifes/__init__.py
--rw-r--r--   0 hwei       (501) staff       (20)     1161 2022-02-16 14:49:04.000000 knifes-0.8.89/knifes/aes.py
--rw-r--r--   0 hwei       (501) staff       (20)      573 2023-07-29 07:38:53.000000 knifes-0.8.89/knifes/alarm.py
--rw-r--r--   0 hwei       (501) staff       (20)      740 2022-01-21 03:14:54.000000 knifes-0.8.89/knifes/auth.py
--rw-r--r--   0 hwei       (501) staff       (20)      502 2023-07-29 10:19:19.000000 knifes-0.8.89/knifes/constants.py
--rw-r--r--   0 hwei       (501) staff       (20)     7208 2023-07-31 13:37:02.000000 knifes-0.8.89/knifes/decorators.py
--rw-r--r--   0 hwei       (501) staff       (20)     7567 2023-06-14 01:08:29.000000 knifes-0.8.89/knifes/deploy.py
--rw-r--r--   0 hwei       (501) staff       (20)     1140 2022-10-14 05:30:31.000000 knifes-0.8.89/knifes/digests.py
--rw-r--r--   0 hwei       (501) staff       (20)      363 2023-02-01 04:12:33.000000 knifes-0.8.89/knifes/envconfig.py
--rw-r--r--   0 hwei       (501) staff       (20)     1649 2022-11-17 08:15:03.000000 knifes-0.8.89/knifes/file.py
--rw-r--r--   0 hwei       (501) staff       (20)     5108 2023-06-15 01:37:33.000000 knifes-0.8.89/knifes/getui.py
--rw-r--r--   0 hwei       (501) staff       (20)      732 2022-03-13 09:06:03.000000 knifes-0.8.89/knifes/jsons.py
--rw-r--r--   0 hwei       (501) staff       (20)      403 2023-07-29 07:38:53.000000 knifes-0.8.89/knifes/logging.py
--rw-r--r--   0 hwei       (501) staff       (20)      474 2023-06-15 08:19:17.000000 knifes-0.8.89/knifes/media.py
--rw-r--r--   0 hwei       (501) staff       (20)      924 2023-02-21 04:17:56.000000 knifes-0.8.89/knifes/misc.py
--rw-r--r--   0 hwei       (501) staff       (20)      204 2022-11-22 04:39:29.000000 knifes-0.8.89/knifes/operators.py
--rw-r--r--   0 hwei       (501) staff       (20)      569 2022-11-23 13:58:35.000000 knifes-0.8.89/knifes/package.py
--rw-r--r--   0 hwei       (501) staff       (20)      863 2023-07-31 13:36:03.000000 knifes-0.8.89/knifes/randoms.py
--rw-r--r--   0 hwei       (501) staff       (20)     1895 2023-07-30 11:26:01.000000 knifes-0.8.89/knifes/results.py
--rw-r--r--   0 hwei       (501) staff       (20)     2235 2022-05-30 13:46:32.000000 knifes-0.8.89/knifes/roar.py
--rw-r--r--   0 hwei       (501) staff       (20)      446 2022-01-21 03:14:54.000000 knifes-0.8.89/knifes/shell.py
--rw-r--r--   0 hwei       (501) staff       (20)     2022 2023-07-31 14:57:01.000000 knifes-0.8.89/knifes/sms.py
--rw-r--r--   0 hwei       (501) staff       (20)      889 2023-02-01 04:20:34.000000 knifes-0.8.89/knifes/strings.py
--rw-r--r--   0 hwei       (501) staff       (20)     1335 2023-07-31 13:41:32.000000 knifes-0.8.89/knifes/times.py
--rw-r--r--   0 hwei       (501) staff       (20)     3245 2023-06-15 07:38:41.000000 knifes-0.8.89/knifes/urls.py
--rw-r--r--   0 hwei       (501) staff       (20)     4396 2022-11-25 02:07:08.000000 knifes-0.8.89/knifes/useragent.py
-drwxr-xr-x   0 hwei       (501) staff       (20)        0 2023-07-31 14:58:12.965556 knifes-0.8.89/knifes.egg-info/
--rw-r--r--   0 hwei       (501) staff       (20)      766 2023-07-31 14:58:12.000000 knifes-0.8.89/knifes.egg-info/PKG-INFO
--rw-r--r--   0 hwei       (501) staff       (20)      626 2023-07-31 14:58:12.000000 knifes-0.8.89/knifes.egg-info/SOURCES.txt
--rw-r--r--   0 hwei       (501) staff       (20)        1 2023-07-31 14:58:12.000000 knifes-0.8.89/knifes.egg-info/dependency_links.txt
--rw-r--r--   0 hwei       (501) staff       (20)       27 2023-07-31 14:58:12.000000 knifes-0.8.89/knifes.egg-info/requires.txt
--rw-r--r--   0 hwei       (501) staff       (20)        7 2023-07-31 14:58:12.000000 knifes-0.8.89/knifes.egg-info/top_level.txt
--rw-r--r--   0 hwei       (501) staff       (20)      103 2022-02-08 15:08:46.000000 knifes-0.8.89/pyproject.toml
--rw-r--r--   0 hwei       (501) staff       (20)       38 2023-07-31 14:58:12.965914 knifes-0.8.89/setup.cfg
--rw-r--r--   0 hwei       (501) staff       (20)      901 2023-07-31 14:57:57.000000 knifes-0.8.89/setup.py
...
### Comparing `knifes-0.8.89/PKG-INFO` & `knifes-0.8.9/PKG-INFO`
...
### Comparing `knifes-0.8.89/knifes/aes.py` & `knifes-0.8.9/knifes/aes.py`

 * *Files identical despite different names*

### Comparing `knifes-0.8.89/knifes/auth.py` & `knifes-0.8.9/knifes/auth.py`

 * *Files identical despite different names*

### Comparing `knifes-0.8.89/knifes/deploy.py` & `knifes-0.8.9/knifes/deploy.py`
...
### Comparing `knifes-0.8.89/knifes/digests.py` & `knifes-0.8.9/knifes/digests.py`

 * *Files identical despite different names*

### Comparing `knifes-0.8.89/knifes/jsons.py` & `knifes-0.8.9/knifes/jsons.py`

 * *Files identical despite different names*

### Comparing `knifes-0.8.89/knifes/misc.py` & `knifes-0.8.9/knifes/misc.py`
...
### Comparing `knifes-0.8.89/knifes/randoms.py` & `knifes-0.8.9/knifes/randoms.py`
...
### Comparing `knifes-0.8.89/knifes/results.py` & `knifes-0.8.9/knifes/results.py`
...
### Comparing `knifes-0.8.89/knifes/roar.py` & `knifes-0.8.9/knifes/roar.py`

 * *Files identical despite different names*

### Comparing `knifes-0.8.89/knifes/sms.py` & `knifes-0.8.9/knifes/sms.py`
...
### Comparing `knifes-0.8.89/knifes/strings.py` & `knifes-0.8.9/knifes/strings.py`
...
### Comparing `knifes-0.8.89/knifes/times.py` & `knifes-0.8.9/knifes/times.py`
...
### Comparing `knifes-0.8.89/knifes/urls.py` & `knifes-0.8.9/knifes/urls.py`
...
### Comparing `knifes-0.8.89/knifes/useragent.py` & `knifes-0.8.9/knifes/useragent.py`
...
### Comparing `knifes-0.8.89/knifes.egg-info/PKG-INFO` & `knifes-0.8.9/knifes.egg-info/PKG-INFO`
...
### Comparing `knifes-0.8.89/knifes.egg-info/SOURCES.txt` & `knifes-0.8.9/knifes.egg-info/SOURCES.txt`
...
### Comparing `knifes-0.8.89/setup.py` & `knifes-0.8.9/setup.py`

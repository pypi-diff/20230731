# Comparing `tmp/SocksDriver-1.1.tar.gz` & `tmp/SocksDriver-1.2.tar.gz`
...
+gzip compressed data, was "SocksDriver-1.2.tar", last modified: Mon Jul 31 09:22:49 2023, max compression
```

## Comparing `SocksDriver-1.1.tar` & `SocksDriver-1.2.tar`
...
+drwxr-xr-x   0 dsw       (1000) dsw       (1000)        0 2023-07-31 09:22:49.255940 SocksDriver-1.2/
+-rw-r--r--   0 dsw       (1000) dsw       (1000)     1068 2023-07-25 21:34:45.000000 SocksDriver-1.2/LICENSE
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      419 2023-07-31 09:22:49.254943 SocksDriver-1.2/PKG-INFO
+-rw-r--r--   0 dsw       (1000) dsw       (1000)       60 2023-07-27 06:33:28.000000 SocksDriver-1.2/README.md
+drwxr-xr-x   0 dsw       (1000) dsw       (1000)        0 2023-07-31 09:22:49.226021 SocksDriver-1.2/SocksDriver/
+-rw-r--r--   0 dsw       (1000) dsw       (1000)       43 2023-07-23 10:49:49.000000 SocksDriver-1.2/SocksDriver/__init__.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)     8366 2023-07-31 09:21:44.000000 SocksDriver-1.2/SocksDriver/client.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      483 2023-07-24 10:07:13.000000 SocksDriver-1.2/SocksDriver/complex_types.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      249 2023-07-24 07:59:31.000000 SocksDriver-1.2/SocksDriver/errors.py
+drwxr-xr-x   0 dsw       (1000) dsw       (1000)        0 2023-07-31 09:22:49.233002 SocksDriver-1.2/SocksDriver.egg-info/
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      419 2023-07-31 09:22:49.000000 SocksDriver-1.2/SocksDriver.egg-info/PKG-INFO
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      559 2023-07-31 09:22:49.000000 SocksDriver-1.2/SocksDriver.egg-info/SOURCES.txt
+-rw-r--r--   0 dsw       (1000) dsw       (1000)        1 2023-07-31 09:22:49.000000 SocksDriver-1.2/SocksDriver.egg-info/dependency_links.txt
+-rw-r--r--   0 dsw       (1000) dsw       (1000)       12 2023-07-31 09:22:49.000000 SocksDriver-1.2/SocksDriver.egg-info/top_level.txt
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      425 2023-07-31 09:21:44.000000 SocksDriver-1.2/pyproject.toml
+-rw-r--r--   0 dsw       (1000) dsw       (1000)       38 2023-07-31 09:22:49.255940 SocksDriver-1.2/setup.cfg
+drwxr-xr-x   0 dsw       (1000) dsw       (1000)        0 2023-07-31 09:22:49.251951 SocksDriver-1.2/tests/
+-rw-r--r--   0 dsw       (1000) dsw       (1000)     2090 2023-07-24 09:58:57.000000 SocksDriver-1.2/tests/test_command_blockdev.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      703 2023-07-27 06:33:28.000000 SocksDriver-1.2/tests/test_command_help.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      329 2023-07-25 07:34:53.000000 SocksDriver-1.2/tests/test_command_meminfo.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      290 2023-07-24 09:12:37.000000 SocksDriver-1.2/tests/test_command_sleep.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      469 2023-07-24 09:12:17.000000 SocksDriver-1.2/tests/test_command_sysinfo.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      564 2023-07-24 09:11:50.000000 SocksDriver-1.2/tests/test_command_uptime.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      231 2023-07-27 06:33:28.000000 SocksDriver-1.2/tests/test_command_version.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)      514 2023-07-25 06:00:12.000000 SocksDriver-1.2/tests/test_connect_disconnect.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)     1381 2023-07-25 04:53:01.000000 SocksDriver-1.2/tests/test_error_handling.py
+-rw-r--r--   0 dsw       (1000) dsw       (1000)     3632 2023-07-27 08:58:49.000000 SocksDriver-1.2/tests/test_protocol.py
```

### Comparing `SocksDriver-1.1/LICENSE` & `SocksDriver-1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/SocksDriver/client.py` & `SocksDriver-1.2/SocksDriver/client.py`
...
### Comparing `SocksDriver-1.1/SocksDriver.egg-info/SOURCES.txt` & `SocksDriver-1.2/SocksDriver.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_command_blockdev.py` & `SocksDriver-1.2/tests/test_command_blockdev.py`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_command_help.py` & `SocksDriver-1.2/tests/test_command_help.py`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_command_uptime.py` & `SocksDriver-1.2/tests/test_command_uptime.py`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_connect_disconnect.py` & `SocksDriver-1.2/tests/test_connect_disconnect.py`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_error_handling.py` & `SocksDriver-1.2/tests/test_error_handling.py`

 * *Files identical despite different names*

### Comparing `SocksDriver-1.1/tests/test_protocol.py` & `SocksDriver-1.2/tests/test_protocol.py`

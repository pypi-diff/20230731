# Comparing `tmp/e2D-1.0.1.tar.gz` & `tmp/e2D-1.0.2.tar.gz`
...
### Comparing `e2D-1.0.1/LICENSE` & `e2D-1.0.2/LICENSE`
...
### Comparing `e2D-1.0.1/e2D/utils.py` & `e2D-1.0.2/e2D/utils.py`

# Comparing `tmp/boinc_client-1.4.6.tar.gz` & `tmp/boinc_client-1.5.0.tar.gz`
...
### Comparing `boinc_client-1.4.6/src/boinc_client/results.py` & `boinc_client-1.5.0/src/boinc_client/results.py`

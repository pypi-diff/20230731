# Comparing `tmp/tendril-interests-0.3.4.tar.gz` & `tmp/tendril-interests-0.3.5.tar.gz`
...
### Comparing `tendril-interests-0.3.4/docs/conf.py` & `tendril-interests-0.3.5/docs/conf.py`

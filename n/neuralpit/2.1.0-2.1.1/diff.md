# Comparing `tmp/neuralpit-2.1.0.tar.gz` & `tmp/neuralpit-2.1.1.tar.gz`
...
## Comparing `neuralpit-2.1.0.tar` & `neuralpit-2.1.1.tar`
...
### Comparing `neuralpit-2.1.0/PKG-INFO` & `neuralpit-2.1.1/PKG-INFO`
...
### Comparing `neuralpit-2.1.0/pyproject.toml` & `neuralpit-2.1.1/pyproject.toml`
...
### Comparing `neuralpit-2.1.0/src/neuralpit/__init__.py` & `neuralpit-2.1.1/src/neuralpit/__init__.py`

 * *Files identical despite different names*

### Comparing `neuralpit-2.1.0/src/neuralpit/services/conversation.py` & `neuralpit-2.1.1/src/neuralpit/services/conversation.py`
...
### Comparing `neuralpit-2.1.0/src/neuralpit/services/conversion.py` & `neuralpit-2.1.1/src/neuralpit/services/conversion.py`

 * *Files identical despite different names*

### Comparing `neuralpit-2.1.0/src/neuralpit/utils/streamer.py` & `neuralpit-2.1.1/src/neuralpit/utils/streamer.py`

 * *Files identical despite different names*

### Comparing `neuralpit-2.1.0/src/neuralpit.egg-info/PKG-INFO` & `neuralpit-2.1.1/src/neuralpit.egg-info/PKG-INFO`
